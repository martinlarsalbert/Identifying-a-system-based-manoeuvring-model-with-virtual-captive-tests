...
The side force predicted by the MMG model agrees well with the VCT results for positive yaw rates, but not the negative yaw rates, as shown in \autoref{tab:inflow_to_rudder_force} and \autoref{fig:inflow_to_force_circle}. The average inflow angles and speeds are of about the same magnitude for the \textpm 0.07 rad/s yaw rates, yet the VCT rudder side force differs, with -3.9 N compared to 3.3 N. 
\begin{table}[h]
    \centering
