...
\begin{figure}[h!]
     \centering
     \includesvg[height = 4in, width=10.0in]{figures/results_wPCC_ID.zigzag 10_10.svg}
...
\begin{figure}[h]
    \centering
    \includesvg[height = 4in, width=10.0in]{figures/results_wPCC_ID.zigzag 20_20.svg}
