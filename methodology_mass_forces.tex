...
The yaw added mass $N_{\dot{r}}$ was determined with the Fourier series method \citep{sakamotoURANSSimulationsStatic2012} applied on a pure yaw test conducted in a fully non-linear free surface potential flow panel method in ShipFlow Motions (Motions) \citep{kjellbergFullyNonlinearUnsteady2013}.
