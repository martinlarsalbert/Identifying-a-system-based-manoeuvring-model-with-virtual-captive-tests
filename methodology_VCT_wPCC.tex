\begin{table}[h]
    ...
    \pgfplotstabletypeset[col sep=comma, column type=r, style=string type,
        columns/V/.style={column type=r,string type, column name=$V$ [m/s]},
        columns/beta_deg/.style={column type=r,string type, column name=$\beta$ [deg]},
        columns/r/.style={column type=r,string type, column name=$r$ [rad/s]},
        columns/delta_deg/.style={column type=r,string type, column name=$\delta$ [deg]},
        columns/rev/.style={column type=r,string type, column name=rev [1/s]},
