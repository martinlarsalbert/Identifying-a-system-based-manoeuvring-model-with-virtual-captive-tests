...
\begin{figure}[h]
    ...
    \end{subfigure}
    \caption{Inverse dynamics forces during the zigzag tests compared to VCT calculations and predictions with the measured rudder model including model uncertainty.}
